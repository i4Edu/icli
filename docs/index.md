# iCopilot Documentation

Start here.

## Getting started

- [Project README](../README.md) — install, auth, usage at a glance
- [Configuration](./config.md) — env vars, `~/.icopilotrc.json`, CLI flags
- [Recipes](./recipes.md) — practical workflow examples
